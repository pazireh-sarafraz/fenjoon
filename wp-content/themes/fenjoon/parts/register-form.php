<form id="register" action="<?php echo site_url(); ?>/" method="post">
	...
	<a class="button green size2" onclick="document.getElementById('register').submit();"><?php _e( 'Register', 'fenjoon' );?></a>
</form>